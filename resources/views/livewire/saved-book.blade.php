<div>
    ...
    <section class="grid grid-cols-1 xl:grid-cols-2 gap-3 p-5 rounded-lg bg-[#FBFBFB] w-full h-fit mb-3 shadow-lg">
        ...
        @empty
            <div class="flex flex-col items-center col-span-2 py-5">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="200"
                    viewBox="0 0 782.04441 701.88002" role="img" artist="Katerina Limpitsouni"
                    ...
                    <path
                        ...
                        transform="translate(-208.9778 -99.05999)" fill="#fff" />
                    <circle cx="694.19401" cy="614.02963" r="87.85039" fill="#7353ba" />
                    <path
                    ...
                    <path
                        ...
                        transform="translate(-208.9778 -99.05999)" fill="#7353ba" />
                </svg>
                ...
                <p class="mt-2 max-w-sm text-lg text-center font-light">
                    Disini adalah tempat buku yang anda simpan ditampilkan.
                    <a href="{{ route('book.explore') }}" wire:navigate class="underline hover:text-primary">Jelajahi
                        Buku.</a>
                </p>
            </div>
        @endforelse
