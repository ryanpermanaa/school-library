<x-layouts.app title="Explore" class="">
    <section class="flex items-center justify-between gap-7 p-5 rounded-lg bg-[#FBFBFB] w-full h-fit mb-4 shadow-lg">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-3 [&>div]:bg-[#E0E0E0]">
            @foreach ($popular_books as $book)
                <div
                    ...
                    <div class="bg-white p-5 flex-1 rounded-b-xl">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-3 [&>div]:bg-[#E0E0E0]">
            @foreach ($latest_books as $book)
                <div
                    ...
                    <div class="bg-white flex-1 p-5 rounded-b-xl">
                        <div class="font-medium text-primary flex text-sm items-start gap-3 mb-2">
                            <span>
                                <i class="fa-solid fa-thumbs-up mr-0.5"></i>
                                <b>{{ $book->likedByUsers->count() }}</b>
